...
export const WINDOW_TYPES = {
    ...
    PROJECT_INSPIRED: "PROJECT_INSPIRED",
    PROJECT_STUDIO: "PROJECT_STUDIO",
    PROJECT_HOTEL: "PROJECT_HOTEL",
    PROJECT_FISHING: "PROJECT_FISHING",
    PROJECT_NATIVEPLACES: "PROJECT_NATIVEPLACES",
    PROJECT_GOSTUDY: "PROJECT_GOSTUDY",
};
